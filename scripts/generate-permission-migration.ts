...
// ---------------------------------------------------------------------------
const ROLE_GROUP_NAMES: Record<string, string> = {
  SUPER_ADMIN_PERMISSIONS: UserRole.SUPER_ADMIN,
  COUNSELOR_PERMISSIONS: UserRole.COUNSELOR,
  ADMIN_PERMISSIONS: UserRole.ADMIN,
  LEARNER_PERMISSIONS: UserRole.LEARNER,
  CLIENT_PERMISSIONS: UserRole.CLIENT,
  REVIEWER_PERMISSIONS: UserRole.REVIEWER,
};
