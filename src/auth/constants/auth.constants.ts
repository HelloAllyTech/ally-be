export const PERMISSIONS = {
  ...
  // ViewButtonStartScenarioSession: 'view:button:start-scenario-session',
  ViewScenarioSession: 'view:scenario-session',
  ViewAdminScenarioSession: 'view:admin:scenario-session',
  ViewScenarioSessionSummary: 'view:scenario-session:summary',
};
