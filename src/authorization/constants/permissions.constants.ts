const PERMISSIONS = {
  ...
  EDIT_GROUPS_PERMISSION: 'edit:groups:permission',
  DELETE_GROUPS_PERMISSION: 'delete:groups:permission',
};
...
const SUPER_ADMIN_PERMISSIONS = [
  ...
  PERMISSIONS.EDIT_GROUPS_PERMISSION,
  PERMISSIONS.DELETE_GROUPS_PERMISSION,
];
