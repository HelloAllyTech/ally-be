const PERMISSIONS = {
  ...
  VIEW_SETTINGS_CUSTOM_FIELD_TYPES: 'view:settings:custom-field-types',
  EDIT_SETTINGS_CUSTOM_FIELD_TYPES: 'edit:settings:custom-field-types',
...
const COUNSELOR_PERMISSIONS = [
  ...
  PERMISSIONS.VIEW_CUSTOM_FIELD_DEFINITIONS,
