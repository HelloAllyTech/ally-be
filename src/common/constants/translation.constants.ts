...
/**
 * Conversational tone examples for each language
 * Shows formal vs. casual examples to guide LLM prompts
 */
export const CONVERSATIONAL_EXAMPLES: Record<string, string> = {
  hi: `
Tone correction example:

❌ Formal:
"कृपया ग्राहक को समझने का प्रयास करें"

✅ Casual:
"यार, customer को कैसे handle करना है समझ ले"
`,
...
❌ Formal:
"தயவுசெய்து வாடிக்கையாளரை புரிந்துகொள்ளுங்கள்"

✅ Casual:
"டா, customer-ஐ எப்படி handle பண்ணணும் புரிஞ்சுக்கோ"
`,
...
❌ Formal:
"దయచేసి కస్టమర్‌ను అర్థం చేసుకోండి"

✅ Casual:
"రా, customer-నీ ఎలా handle చేయాలో అర్థం చేసుకో"
`,
...
❌ Formal:
"ದಯವಿಟ್ಟು ಗ್ರಾಹಕನನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳಿ"

✅ Casual:
"ದಾ, customer-ನ್ನ ಹೇಗೆ handle ಮಾಡಬೇಕು ಅರ್ಥ ಮಾಡಿಕೊ"
`,
...
❌ Formal:
"ദയവായി ഉപഭോക്താവിനെ മനസ്സിലാക്കുക"

✅ Casual:
"ഡാ, customer-നെ എങ്ങനെ handle ചെയ്യണം മനസ്സിലാക്കിക്കോ"
`,
...
❌ Formal:
"કૃપા કરીને ગ્રાહકને સમજો"

✅ Casual:
"યાર, customer-ને કેવી રીતે handle કરવો એ સમજ લે"
`,
...
❌ Formal:
"कृपया ग्राहकाला समजून घ्या"

✅ Casual:
"अरे, customer-ला कसं handle करायचं ते समजून घे"
`,
...
❌ Formal:
"অনুগ্রহ করে গ্রাহককে বুঝুন"

✅ Casual:
"যার, customer-কে কীভাবে handle করতে হয় বুঝে নে"
`,
...
❌ Formal:
"ਕਿਰਪਾ ਕਰਕੇ ਗਾਹਕ ਨੂੰ ਸਮਝੋ"

✅ Casual:
"ਯਾਰ, customer-ਨੂੰ ਕਿਵੇਂ handle ਕਰਨਾ ਆ ਉਹ ਸਮਝ ਲੈ"
`,
...
❌ Formal:
"ଦୟାକରି ଗ୍ରାହକକୁ ବୁଝନ୍ତୁ"

✅ Casual:
"ଯାର, customer-କୁ କେମିତି handle କରିବା ଦରକାର ବୁଝିନେ"
`,
};
