...
export class AddScenarioPathTables1763619821855 implements MigrationInterface {
  name = 'AddScenarioPathTables1763619821855';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "scenario_path_session_items" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "scenarioPathSessionId" uuid NOT NULL, "userId" integer NOT NULL, "scenarioPathItemId" uuid NOT NULL, "status" character varying NOT NULL DEFAULT 'UNLOCKED', "deletedAt" TIMESTAMP, CONSTRAINT "PK_a81cafd4bfff099319500334ff7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "scenario_path_tenants" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "scenarioPathId" uuid NOT NULL, "tenantId" uuid NOT NULL, "deletedAt" TIMESTAMP, CONSTRAINT "PK_c275194faf62575b8bba37c8faa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "scenario_path_items" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "scenarioPathId" uuid NOT NULL, "scenarioId" integer NOT NULL, "order" integer NOT NULL, "messageTitle" character varying, "messageContent" character varying, "minimumScore" integer, "deletedAt" TIMESTAMP, CONSTRAINT "PK_b433a70a0be16850421b020c4d3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
