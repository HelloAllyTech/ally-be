  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "scenario_trigger_warnings" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "scenarioId" integer NOT NULL, "triggerWarningId" character varying NOT NULL, CONSTRAINT "PK_b063681b6dbada4279f6c6cd7f4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
