...
export class LanguageTranslationsTable1765966044770 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_session_events_translations_session_event_id_language_id_idx" ON "session_events_translations" ("sessionEventId", "languageId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_scenario_translations_scenario_id_language_id_idx" ON "scenario_translations" ("scenarioId", "languageId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_scenario_events_translations_scenario_id_event_id_language_id_idx" ON "scenario_events_translations" ("scenarioId", "eventId", "languageId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."uq_scenario_events_translations_scenario_id_event_id_language_id_idx"`,
    );
    await queryRunner.query(`DROP TABLE "scenario_events_translations"`);
    await queryRunner.query(
      `DROP INDEX "public"."uq_scenario_translations_scenario_id_language_id_idx"`,
    );
    await queryRunner.query(`DROP TABLE "scenario_translations"`);
    await queryRunner.query(
      `DROP INDEX "public"."uq_session_events_translations_session_event_id_language_id_idx"`,
    );
