...
/**
 * Promotes shubham.bhoite+admin@helloally.ai from SUPER_ADMIN to
 * SUPER_DUPER_ADMIN, following the same pattern as
 * 1839000000000-PromoteGopikrishnanAdminToSuperDuperAdmin.
 *
...
const PROMOTE_EMAIL = 'shubham.bhoite+admin@helloally.ai';

export class PromoteShubhamAdminToSuperDuperAdmin1840000000000 implements MigrationInterface {
