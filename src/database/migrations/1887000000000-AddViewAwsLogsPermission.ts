...
/**
 * Permission for the new AWS CloudWatch Logs viewer (super-duper-admin-only
 * "Logs" tab). Granted ONLY to SUPER_DUPER_ADMIN, same divergence pattern as
 * SuperDuperAdminManagementPermissions1847000000000 — these services' logs
 * can carry sensitive request data.
 *
 ...
 */
const NEW_PERMISSIONS = ['view:aws-logs'];

const GROUP_GRANTS: Record<string, string[]> = {
  SUPER_DUPER_ADMIN: NEW_PERMISSIONS,
};

export class AddViewAwsLogsPermission1887000000000 implements MigrationInterface {
