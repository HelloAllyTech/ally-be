 ...
 *
 * The corpus is targeted per organisation (AddKbDocumentAudience1966000000000), so the bot
 ...
 */
export class CreateWaPhoneMappings1966200000000 implements MigrationInterface {
  name = 'CreateWaPhoneMappings1966200000000';
