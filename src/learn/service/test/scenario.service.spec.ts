...
describe('ScenarioService', () => {
  ...
  describe('getScenario', () => {
    it('should return scenario with correct simulationCount when states are present', async () => {
      const mockScenarioWithStates = {
        ...mockScenario,
        metadata: {
          ...mockScenario.metadata,
          states: [
    ...
    it('should return scenario with simulationCount of 0 when no states are present', async () => {
      const mockScenarioWithoutStates = {
        ...mockScenario,
        metadata: {
          ...mockScenario.metadata,
          states: [],
    ...
    it('should return scenario with simulationCount of 0 when metadata is null', async () => {
      const mockScenarioWithNullMetadata = {
        ...mockScenario,
        metadata: undefined,
      };
      scenariosRepository.getScenarioById.mockResolvedValue(
        mockScenarioWithNullMetadata,
      );
    ...
    it('should return scenario with simulationCount of 0 when metadata.states is undefined', async () => {
      const mockScenarioWithUndefinedStates = {
        ...mockScenario,
        metadata: {
          ...mockScenario.metadata,
          states: undefined,
      ...
      scenariosRepository.getScenarioById.mockResolvedValue(
        mockScenarioWithUndefinedStates,
      );
